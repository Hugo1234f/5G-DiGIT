...
def show_forest():
    ...
    ax1.scatter(forest_f0['PCA1'], forest_f0['PCA2'], c=forest_f0['Label'], cmap="coolwarm", s=20)
    ax1.set_title("Frequency 3649.44MHz")
    ax1.set_xlabel("PCA 1")
    ax1.set_ylabel("PCA 2")

    ax2.scatter(forest_f1['PCA1'], forest_f1['PCA2'], c=forest_f1['Label'], cmap="coolwarm", s=20)
